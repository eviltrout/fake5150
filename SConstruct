...
opts.Add(PathVariable("target_name", "The library name.", "libsarien", PathVariable.PathAccept))
...
env.Append(CPPPATH=[".", sarien_headers_path])
...
sources = [ Glob("src/sarien.c"), Glob("sarien/*.c") ]

# objects = env.Object(source=sarien)
